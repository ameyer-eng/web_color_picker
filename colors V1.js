 ...
 // get the reference for the body
  ...
  for (var i = 0; i < num_of_rows; i++) {
    ...
    for (var j = 0; j < 16; j++) {
      ...
      var color = "#" +componentToHex(i*15) + componentToHex(j*15)+ componentToHex(i*j*3);
...
{
    console.log("BAKSDFJLASJDFKLAKDF");
    var namestring = "";
    var color = document.getElementById(blah.id).getAttribute("style", "background-color:").toString();
    console.log(color);
    document.getElementById("stupidParagraph").setAttribute("style", "background-color:"+ color + ";");
